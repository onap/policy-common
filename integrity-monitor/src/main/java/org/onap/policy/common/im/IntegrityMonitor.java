...
public class IntegrityMonitor {
    ...
    public String stateCheck(String dep) {
        ...
        if (errorMsg == null) {
            errorMsg = checkDependentStates(errorMsg, dep, stateManagementEntity);
        }
    ...
    private String checkDependentStates(String errorMsg, String dep, StateManagementEntity stateManagementEntity) {
