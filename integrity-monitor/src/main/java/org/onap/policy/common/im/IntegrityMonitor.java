...
public class IntegrityMonitor {
    ...
    private String jmxCheck(String dep) {
        ...
        String errorMsg =
            withinTransaction(dep + ": ResourceRegistrationEntity DB read failed with exception: ",
                () -> jmxCheck2(dep, jmxUrl));

        if (jmxUrl.get() != null) {
            JmxAgentConnection jmxAgentConnection = null;
            try {
                jmxAgentConnection = new JmxAgentConnection(jmxUrl.get());
    ...
    private String jmxCheck2(String dep, AtomicReference<String> jmxUrl) {
        ...
        if (!rrList.isEmpty()) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Dependent Resource={}, url={}, createdDate={}", dep, jmxUrl,
                                rrx.getCreatedDate());
            }
