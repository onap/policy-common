...
public class TestValidation {
    ...
    public void testParameterValidationResult_NotNull() throws Exception {
        ...
        assertEquals("field 'notNullString' type 'java.lang.String' value 'null' INVALID, is null\n".replace('\'', '"'),
                        result.getResult());
    ...
    public void testParameterValidationResult_NotBlank() throws Exception {
        ...
        assertEquals(ValidationStatus.INVALID, result.getStatus());
        assertEquals("field 'notBlankString' type 'java.lang.String' value '' INVALID, must be a non-blank string\n"
                        .replace('\'', '"'), result.getResult());
         ...
         * Check plain object fields, too.
         */
        result = new ParameterValidationResult(TestValidation.class.getDeclaredField("notBlankObject"), null);
        assertEquals(ValidationStatus.CLEAN, result.getStatus());

        result = new ParameterValidationResult(TestValidation.class.getDeclaredField("notBlankObject"), new Object());
        assertEquals(ValidationStatus.CLEAN, result.getStatus());
