...
public class ParameterGroupWithParameterGroupCollection implements AbstractParameterGroup {
    private String name;
    private List<AbstractParameterGroup> parameterGroupArrayList = new ArrayList<>();
    ...
    public List<AbstractParameterGroup> getIntArrayList() {
