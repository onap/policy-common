...
public class TestParametersL00 implements AbstractParameterGroup {
    private String name;
    public int l00IntField = 0;
    public String l00StringField = "Legal " + this.getClass().getCanonicalName();
    public TestParametersL10 l00L10Nested = new TestParametersL10("l00L10Nested");
    public TestParametersLGeneric l00LGenericNested = new TestParametersLGeneric("l00LGenericNested");
    public Map<String, TestParametersLGeneric> l00LGenericNestedMap = new LinkedHashMap<>();
    ...
    public GroupValidationResult validate() {
        ...
        } else if (l00IntField > 1) {
            validationResult.setResult("l00IntField", ValidationStatus.WARNING,
                            "values greater than 1 are not recommended");
        } else if (l00IntField == 1) {
            validationResult.setResult("l00IntField", ValidationStatus.OBSERVATION, "this field has been set to 1");
        } else {
