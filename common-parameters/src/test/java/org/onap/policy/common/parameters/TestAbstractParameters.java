...
public class TestAbstractParameters {
    ...
    public void testAbstractParameters() {
        ...
        try {
            ...
            assertEquals("class \"org.onap.policy.common.parameters.LegalParameters\" is not an instance of "
                            + "\"org.onap.policy.common.parameters.IllegalParametersBadClass\"", e.getMessage());
        }
    }
}
