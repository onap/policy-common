...
public class GroupMapValidationResult implements ValidationResult {
    ...
    protected GroupMapValidationResult(final Field field, final Object mapObject) {
        ...
        Map<String, AbstractParameterGroup> parameterGroupMap = (Map<String, AbstractParameterGroup>) mapObject;

        // Add a validation result per map entry
        for (Entry<String, AbstractParameterGroup> parameterGroupMapEntry : parameterGroupMap.entrySet()) {
