...
public class ServiceManagerTest {
    ...
    public void testStart() {
        ...
        Startable start2 = mock(Startable.class);
        svcmgr.addService("second test start", start2);
        ...
        svcmgr.addService("third test start", start3);

        Startable start4 = mock(Startable.class);
        svcmgr.addService("fourth test start", start4);

        Startable start5 = mock(Startable.class);
        svcmgr.addService("fifth test start", start5);
    ...
    public void testStop() throws Exception {
        RunnableWithEx start1 = mock(RunnableWithEx.class);
        RunnableWithEx stop1 = mock(RunnableWithEx.class);
        svcmgr.addAction("first stop", start1, stop1);

        Startable start2 = mock(Startable.class);
        svcmgr.addService("second stop", start2);
