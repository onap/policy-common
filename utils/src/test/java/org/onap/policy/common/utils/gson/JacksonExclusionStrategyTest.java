...
public class JacksonExclusionStrategyTest {
    ...
    public void testIsManaged() {
        ...
        assertFalse(JacksonExclusionStrategy.isManaged(Intfc.class));
        ...
        // wrong package
        assertFalse(JacksonExclusionStrategy.isManaged(java.lang.reflect.Field.class));
        assertFalse(JacksonExclusionStrategy.isManaged(javax.accessibility.AccessibleBundle.class));
    }
