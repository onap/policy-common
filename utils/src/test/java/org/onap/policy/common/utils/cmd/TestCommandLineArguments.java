...
/**
 * Class for unit testing CommandLineArguments class.
 *
...
public class TestCommandLineArguments {
    ...
    public void testVersion() throws CommandLineException {
        String[] version = {"-v"};
        assertTrue(testCmd.parse(version).startsWith("ONAP Version test."));
    }

    @Test
    public void testHelp() throws CommandLineException {
        String[] help = {"-h"};
        assertTrue(testCmd.parse(help).startsWith("usage: org.onap.policy.HelpClass [options...]"));
    }
    ...
    public void testParse() throws CommandLineException {
        ...
        assertTrue(testCmd.getFullConfigurationFilePath().contains(TEST_CONFIG_FILE));
    }

    @Test
    public void testParse_ShouldThrowExceptionWithInvalidArguments() {
        String[] invalidArgs = {"-a"};
        String expectedErrorMsg = "invalid command line arguments specified: Unrecognized option: -a";
        assertThatThrownBy(() -> testCmd.parse(invalidArgs)).hasMessage(expectedErrorMsg);
    }
    ...
    public void testParse_ShouldThrowExceptionWhenFileNameNull() {
        ...
        String expectedErrorMsg = "invalid command line arguments specified: null";
        assertThatThrownBy(() -> testCmd.parse(nullArgs)).hasMessage(expectedErrorMsg);
    }
    ...
    public void testValidate_ShouldThrowExceptionWhenConfigFileNotPresent() throws CommandLineException {
        ...
        assertValidate(versionArgs, "fake policy cpm configuration file was not specified as an argument");
    }

    @Test
    public void testValidate_ShouldThrowExceptionWhenFileNameEmpty() {
        String[] argsOnlyKeyNoValue = {"-c", ""};
        assertValidate(argsOnlyKeyNoValue, "fake policy cpm configuration file was not specified as an argument");
    ...
    public void testAddExtraOptions() throws CommandLineException {
        ...
        assertTrue(testCmdExtraOpt.getFullPropertyFilePath().contains(TEST_PROPERTY_FILE));
    ...
    public void testNewOptions() throws CommandLineException {
        ...
        String expectedErrorMsg = "invalid command line arguments specified: Unrecognized option: -c";
        assertThatThrownBy(() -> testCmdExtraOpt.parse(argsError)).hasMessage(expectedErrorMsg);
    }
