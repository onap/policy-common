...
public class CryptoUtilsTest {
    ...
    public void testEncrypt() throws GeneralSecurityException {  
        ...
        System.out.println("original value : " + pass + "  encrypted value: " + encryptedValue);  

        String decryptedValue = cryptoUtils.decrypt(encryptedValue);
        System.out.println("encrypted value: " + encryptedValue + "  decrypted value : " + decryptedValue);
    ...
    public void testDecrypt() throws GeneralSecurityException {
        ...
        System.out.println("encrypted value: " + encryptedPass + "  decrypted value : " + decryptedValue);  
        assertEquals(pass, decryptedValue);
    }   
    ...
    public void testAll() {
        ...
        System.out.println("encrypted value: " + encryptedAgain + "  decrypted value : " + decryptedValue);  
        assertEquals(pass, decryptedValue);
