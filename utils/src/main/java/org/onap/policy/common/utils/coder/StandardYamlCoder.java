...
public class StandardYamlCoder extends StandardCoder {
    ...
    /**
     * Converts a Yaml scalar into a corresponding gson primitive. Everything is treated
     * as a string; gson will do the proper data-type conversion when it constructs the
     * POJO.
     *
     * @param node node to be converted
     * @return a gson element corresponding to the node
