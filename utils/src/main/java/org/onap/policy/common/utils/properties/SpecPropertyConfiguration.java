 ...
 * <dl>
 * <dt>aaa{$}Ddd</dt>
 * <dd>if the specialization is "Xxx", then it looks for the value associated with
 ...
 * value associated with property named "aaaDdd" (i.e., without the specialization)</dd>
 * <dt>aaa</dt>
 * <dd>simply looks for the value associated with property named "aaa", without using the
 * specialization</dd>
 * </dl>
 * <p>
...
public class SpecPropertyConfiguration extends PropertyConfiguration {
    ...
    /**
     * Pattern to extract the specializer from a property name. Group 1 matches the "{$}"
     * case, while groups 2 and 3 match the prefix and suffix, respectively, of the
     * {prefix?suffix} case.
     */
     ...
     * populated later by invoking {@link #setAllFields(Properties, String)}.
     * 
    ...
    protected String getRawPropertyValue(Properties props, String propnm) {
        ...
        if (!mat.find()) {
            ...
            return super.getRawPropertyValue(props, prefix + suffix);
        }
    }
