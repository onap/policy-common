...
public class PropertyConfiguration {
    ...
    /**
     * Walks the class hierarchy, populating fields within the object found in each class.
     * 
     * @param visited identifies the classes that have been visited, this is updated as it
     *        works
     * @param clazz current class to be visited
     * @param props properties from which to extract the values
     * @throws PropertyException if an error occurs
     */
