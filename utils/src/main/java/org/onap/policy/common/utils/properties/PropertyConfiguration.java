...
public class PropertyConfiguration {
    ...
    protected Object getValue(Field field, Properties props, Property prop) throws PropertyException {
        ...
        if (clazz == String.class) {
            return getStringValue(field.getName(), props, prop);

        } else if (clazz == Boolean.class || clazz == boolean.class) {
            return getBooleanValue(field.getName(), props, prop);

        } else if (clazz == Integer.class || clazz == int.class) {
            return getIntegerValue(field.getName(), props, prop);

        } else if (clazz == Long.class || clazz == long.class) {
            return getLongValue(field.getName(), props, prop);
    ...
    private void checkSetter(Method setter, Property prop) throws PropertyAccessException {
        ...
        if (Modifier.isStatic(mod)) {
            throw new PropertyAccessException(prop.name(), setter.getName(), "'static' variable cannot be modified");
        }
    }
