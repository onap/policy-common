...
/**
 * This is a simple object registry, similar in spirit to JNDI, but suitable for use in a stand-alone JVM.
 */
public class Registry {
    ...
    /**
     * Creates a new registry instance. This is typically only used by junit tests.
     */
