...
public class PropertyInvalidException extends PropertyException {
     ...
     */
    public PropertyInvalidException(String propnm, Field field) {
        super(propnm, field);
    }
     ...
     */
    public PropertyInvalidException(String propnm, Field field, String message) {
     ...
     */
    public PropertyInvalidException(String propnm, Field field, Throwable cause) {
     ...
     * @param cause cause of the exception
     */
    public PropertyInvalidException(String propnm, Field field, String message, Throwable cause) {
