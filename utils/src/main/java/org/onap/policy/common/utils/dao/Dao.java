 ...
 *
 * <p>
 * This can be used with a try-with-resources statement. When {@link #close()} is invoked,
 * any active transaction will automatically be rolled back. Note: only one transaction
