...
public class BeanConfigurator {
    ...
    private Method getGetter(Field field, Property prop) throws PropertyAccessException {
        ...
        try {
            ...
            if (field.getType() == Boolean.class || field.getType() == boolean.class) {
                // boolean - check for "isXxx" method before checking for "getXxx" method
                try {
     ...
     * @throws PropertyAccessException if an error occurs
     */
    private Object getBeanValue(Object bean, Field field, Method getter, Property prop) throws PropertyAccessException {
        try {
