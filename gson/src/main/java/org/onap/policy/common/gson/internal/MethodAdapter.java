...
public class MethodAdapter extends Adapter {
    ...
    public static final String INVOKE_ERR = "cannot invoke method to serialize: ";
     ...
     */
    public MethodAdapter(Gson gson, Method accessor, boolean forGetter, Type type) {
        super(gson, accessor, forGetter, type);
