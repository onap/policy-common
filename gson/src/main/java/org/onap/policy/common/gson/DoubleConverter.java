...
public class DoubleConverter {
    ...
    /**
     * Converts an entry's value. If the value is a List, then it recursively converts the
     * entries of the List. Likewise with the map, however, the map is converted in place.
     *
