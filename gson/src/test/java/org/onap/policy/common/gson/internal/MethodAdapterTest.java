...
public class MethodAdapterTest {
    ...
    public void testMethodAdapter_testInvoke() throws Exception {
        MethodAdapter adapter = new MethodAdapter(gson, MethodAdapterTest.class.getDeclaredMethod("getValue"), true,
                        String.class);
        assertEquals("hello", adapter.invoke(this));

        MethodAdapter adapter2 = new MethodAdapter(gson,
                        MethodAdapterTest.class.getDeclaredMethod("setValue", String.class), false, String.class);
