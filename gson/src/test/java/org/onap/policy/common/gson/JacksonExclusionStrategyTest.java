...
public class JacksonExclusionStrategyTest {
    ...
    public void testIsManaged() {
        Class<?>[] excluded = {Data.class, Intfc.class, com.google.gson.TypeAdapter.class};
        for (Class<?> clazz : excluded) {
            assertTrue(clazz.getName(), JacksonExclusionStrategy.isManaged(clazz));
        }

        // generic classes
        Class<?>[] included = {new Data[0].getClass(), Enum.class, boolean.class, byte.class, short.class, int.class,
