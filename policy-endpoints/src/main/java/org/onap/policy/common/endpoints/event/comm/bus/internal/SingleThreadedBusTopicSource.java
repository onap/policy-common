...
public abstract class SingleThreadedBusTopicSource extends BusTopicBase
     ...
     * unfinished latch when {@link #start()} is invoked, decremented when {@link #stop()}
     * is invoked. Never null.
     */
        ...
        while (this.alive) {
            ...
            try {
                if (remaining > 0) {
                     ...
                     * fast-fail loop, thus we force it to wait the full fetch time
                     */
