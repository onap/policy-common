...
public interface BusPublisher {
    ...
    public static class KafkaPublisherWrapper implements BusPublisher {
        ...
        protected KafkaPublisherWrapper(BusTopicParams busTopicParams) {
            ...
            kafkaProps.setProperty(ProducerConfig.ACKS_CONFIG, PolicyEndPointProperties.DEFAULT_ACKS_CONFIG);
            kafkaProps.setProperty(ProducerConfig.RETRY_BACKOFF_MS_CONFIG,
                PolicyEndPointProperties.DEFAULT_RETRY_BACKOFF_MS_CONFIG);
            kafkaProps.setProperty(ProducerConfig.RETRIES_CONFIG, PolicyEndPointProperties.DEFAULT_RETRIES_CONFIG);
