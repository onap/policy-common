...
public interface NetLoggerFeatureApi extends OrderedService {
     ...
     */
    public static final OrderedServiceImpl<NetLoggerFeatureApi> providers =
     ...
     */
    public default boolean beforeLog(Logger eventLogger, EventType type, CommInfrastructure protocol, String topic,
                    String message) {
        return false;
    }
     ...
     *         preventing the invocation of lower priority features. False, otherwise.
     */
    public default boolean afterLog(Logger eventLogger, EventType type, CommInfrastructure protocol, String topic,
                    String message) {
        return false;
    }
}
