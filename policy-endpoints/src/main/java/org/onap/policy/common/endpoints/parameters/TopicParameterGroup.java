...
public class TopicParameterGroup extends ParameterGroupImpl {
    ...
    private List<@Valid @NotNull @VerifyTopicParameter TopicParameters> topicSources;
    private List<@Valid @NotNull @VerifyTopicParameter TopicParameters> topicSinks;
