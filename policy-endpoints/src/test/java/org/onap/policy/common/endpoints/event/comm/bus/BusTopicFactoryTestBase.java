...
public abstract class BusTopicFactoryTestBase<T extends Topic> extends TopicFactoryTestBase<T> {
    ...
    /**
     * Tests building a topic using Properties.
     */
     ...
     * @param getter function to test the validity of the property
     * @param values the values to which the property should be set, defaults to
     *        {@code null} and ""
     */
    protected void checkDefault(String builderName, Function<BusTopicParams, Boolean> getter, Object... values) {
        ...
        for (Object value : values2) {
            ...
            assertTrue("default for " + value, getter.apply(getLastParams()));
        }
    }
