...
public class HttpClientPropertiesHelperTest {
    ...
    public void test() {
        ...
        Assert.assertTrue(HttpClientProperties.PROPERTY_HTTP_CLIENT_SERVICES.equals(propHelper.getEndpointPropertyName()));
        ...
        Assert.assertTrue("true".equals(propHelper.getAllowSelfSignedCertificates("X")));
    }
}