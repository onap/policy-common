...
public class TopicEndpointProxyTest {
    ...
    public TopicEndpointProxyTest() {
        ...
        TopicParameters nullCommInfraParams =
                        new NoopTopicPropertyBuilder(PolicyEndPointProperties.PROPERTY_NOOP_SOURCE_TOPICS)
                                        .makeTopic(NOOP_SOURCE_TOPIC).getParams();
        nullCommInfraParams.setTopicCommInfrastructure(null);
        group.getTopicSources().add(nullCommInfraParams);
        group.getTopicSinks().add(nullCommInfraParams);

        TopicParameters invalidCommInfraParams =
                        new NoopTopicPropertyBuilder(PolicyEndPointProperties.PROPERTY_NOOP_SOURCE_TOPICS)
                                        .makeTopic(NOOP_SOURCE_TOPIC).getParams();
        invalidCommInfraParams.setTopicCommInfrastructure("unknown-comm-infra");
