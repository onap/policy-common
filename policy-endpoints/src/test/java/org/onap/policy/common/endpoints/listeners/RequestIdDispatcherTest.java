...
public class RequestIdDispatcherTest {
    ...
    @Test
    public void testRegisterStringMessageHandler() {
        ...
        // should process a message that does NOT have the desired request id
    ...
    public void testUnregisterMessageHandler() {
        ...
        // other handler should still have processed it
    ...
    @Test
    public void testOfferToHandler() {
        // no handler for this
        status = new MyMessage(REQID1);
        primary.onTopicEvent(INFRA, TOPIC, makeSco(status));
