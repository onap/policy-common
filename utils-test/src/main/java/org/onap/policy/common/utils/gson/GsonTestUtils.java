...
public class GsonTestUtils {
    ...
    /**
     * Encodes an object using gson and then compares it to the expected value, after
     * sorting the elements. The text is interpolated (i.e., script elements, of the form
     * ${obj.xxx}, are expanded).
     *
     * @param object the object to be encoded
     * @param expected the expected value
     */
    ...
    public String applyScripts(String text, Object object) {
        ...
        while (mat.find(ibeg)) {
            ...
            int inext = mat.start();
            bldr.append(text.substring(ibeg, inext));
        ...
        bldr.append(text.substring(ibeg));
