 ...
 * waitXxx() methods is invoked. Mock Timers and Executor Services may add work items to
 * the queue.
 *
 * <p/>This only handles relatively simple situations, though it does support
...
public class TestTimeMulti extends TestTime {
    ...
    /**
     * Default value, in milliseconds, for maximum time.
     */
