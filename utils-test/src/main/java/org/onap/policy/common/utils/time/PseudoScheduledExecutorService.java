...
/**
 * Scheduled executor service that uses {@link PseudoTime} to execute its tasks.
 */
class PseudoScheduledExecutorService implements ScheduledExecutorService {
     ...
     */
    public PseudoScheduledExecutorService(PseudoTime currentTime) {
    ...
    /**
     * Cancels all tasks that have not yet been executed. Does <i>not</i> interrupt any
    ...
    public void execute(Runnable command) {
        enqueueRunOnce(0, new FutureTask<>(command, null));
    }
