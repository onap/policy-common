...
class PojoTesterTest {
    ...
    @Test
    void testValidPojoWithExactExclusion() {
        assertDoesNotThrow(() -> PojoTester.testPojos(BASE_PACKAGE + ".pojo.valid", "NonExistent"));
    }

    @Test
    void testExcludeAllClasses() {
        assertThrows(IllegalArgumentException.class,
                () -> PojoTester.testPojos(BASE_PACKAGE + ".pojo.valid", ".*"));
    }
