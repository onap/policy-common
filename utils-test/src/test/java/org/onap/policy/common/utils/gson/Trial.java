        ...
        WrapFactory wrapFactory = new WrapFactory() {
            ...
            public Scriptable wrapAsJavaObject(Context cx, Scriptable scope, Object javaObject, Class<?> staticType) {
                ...
                if (javaObject instanceof CharSequence || javaObject instanceof Number
                    ...
                    // TODO flesh this out using NativeSet
                    throw new UnsupportedOperationException("convert " + javaObject.getClass().getName());

                } else {
                    // handle Map, as well as Beans/POJOs
                    Map<String, ?> map;
                    try {
                        map = coder.convert(javaObject, Map.class);
