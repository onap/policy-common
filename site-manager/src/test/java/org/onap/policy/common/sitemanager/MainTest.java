...
public class MainTest {
    ...
    public void test_process_nonEmptyWithHelpArguments_printHelp() throws IOException {
        ...
        try {
            ...
            final Main objUnderTest = getMain();
            objUnderTest.process(args, printable);
        } catch (final ExitCodeTestException e) {
            assertEquals(0, Main.resourceRegistrationTable.size());
    ...
    public void test_process_extraShowArguments_printHelpAndErrorMessage() {
        ...
        final List<String> expectedErrorMessages =
                Arrays.asList(ErrorMessages.SHOW_EXTRA_ARGUMENTS, ErrorMessages.HELP_STRING);

        runAndAssertErrorMessage(expectedErrorMessages, args);
    ...
    public void test_process_lockShowArguments_printHelpAndErrorMessage() {
        ...
        final List<String> expectedErrorMessages = Arrays.asList(ErrorMessages.LOCK_EXTRA_ARGUMENTS,
    ...
    public void test_process_unknowArguments_printHelpAndErrorMessage() {
        ...
        final List<String> expectedErrorMessages =
                Arrays.asList("x" + ErrorMessages.UNKNOWN_COMMAND, ErrorMessages.HELP_STRING);
    ...
    public void test_process_SetAdminStateArguments_printHelpAndErrorMessage() {
        ...
        final List<String> expectedErrorMessages = Arrays.asList(ErrorMessages.SET_ADMIN_STATE_EXTRA_ARGUMENTS,
    ...
    public void test_process_SetAdminStateArguments_printHelpAndErrorMessage2() {
        ...
        final List<String> expectedErrorMessages =
                Arrays.asList("lock" + ErrorMessages.R_AND_S_OPTIONS_ARE_MUTUALLY_EXCLUSIVE, ErrorMessages.HELP_STRING);
    ...
    public void test_process_unlockShowArguments_printHelpAndErrorMessage() {
        ...
        final List<String> expectedErrorMessages = Arrays.asList(ErrorMessages.UNLOCK_EXTRA_ARGUMENTS,
    ...
    public void test_process_StateAndResourceArguments_printHelpAndErrorMessage() {
        ...
        final List<String> expectedErrorMessages =
                Arrays.asList(ErrorMessages.NO_COMMAND_SPECIFIED, ErrorMessages.HELP_STRING);

        runAndAssertErrorMessage(expectedErrorMessages, args);

    }

    private void runAndAssertErrorMessage(final List<String> expectedErrorMessages, final String[] args) {
        final PrintableImpl printable = new PrintableImpl();
        try {
            final Main objUnderTest = getMain();
            objUnderTest.process(args, printable);
        ...
        final List<String> actualMessages = printable.getResult();
        assertFalse(actualMessages.isEmpty());
        assertEquals(expectedErrorMessages, actualMessages);
    }
