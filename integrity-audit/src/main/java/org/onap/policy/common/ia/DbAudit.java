...
public class DbAudit {
    ...
    private void compareMineWithTheirs(String persistenceUnit, List<IntegrityAuditEntity> iaeList,
        ...
        for (IntegrityAuditEntity iae : iaeList) {
            ...
            Map<Object, Object> theirEntries = getTheirEntries(persistenceUnit, clazzName, iae);
            if (logger.isDebugEnabled()) {
    ...
    private Map<Object, Object> getTheirEntries(String persistenceUnit, String clazzName, IntegrityAuditEntity iae) {
        ...
        return dbDao.getAllEntries(persistenceUnit, theirProperties, clazzName);
    }
    ...
    private int recompareMineWithTheirs(String resourceName, String persistenceUnit, List<IntegrityAuditEntity> iaeList,
        ...
        for (IntegrityAuditEntity iae : iaeList) {
            ...
            // get a map of the instances for their iae indexed by id
            Map<Object, Object> theirEntries = reGetTheirEntries(persistenceUnit, clazzName, keySet, iae);
    ...
    private Map<Object, Object> reGetTheirEntries(String persistenceUnit, String clazzName, Set<Object> keySet,
        ...
        return dbDao.getAllEntries(persistenceUnit, theirProperties, clazzName, keySet);
    }
