 ...
 */
public class DbDao2 {
    private static final Logger logger = FlexLogger.getLogger(DbDao2.class.getName());
     ...
     */
    public DbDao2(String resourceName, String persistenceUnit, Properties properties) throws IntegrityAuditException {
     ...
     * @throws IntegrityAuditException if an error occurs
     */
    protected DbDao2(String resourceName, String persistenceUnit, Properties properties, String altDbUrl)
