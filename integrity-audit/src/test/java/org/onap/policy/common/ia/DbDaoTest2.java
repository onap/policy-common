 ...
 * tasks.
 */
public class DbDaoTest2 extends IntegrityAuditTestBase {
    ...
    public static void setUpBeforeClass() throws Exception {
        IntegrityAuditTestBase.setUpBeforeClass(DEFAULT_DB_URL_PREFIX + DbDaoTest2.class.getSimpleName());
    }
    ...
    public void testNewRegistration() throws Exception {
        ...
        try (EntityTransCloser et = new EntityTransCloser(em.getTransaction())) {
            ...
            iaequery.setParameter("rn", DbDaoTest2.resourceName);
            iaequery.setParameter("pu", DbDaoTest2.A_SEQ_PU);
