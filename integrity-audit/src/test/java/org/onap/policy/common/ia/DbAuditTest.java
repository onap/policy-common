...
public class DbAuditTest extends IntegrityAuditTestBase {
    ...
    public void mismatchTest() throws Exception {
        ...
        new DbDao2(resourceName, A_SEQ_PU, properties2).destroy();

        /*
         * Entries in DB1, pointing to DB2, except for pdp3
         */
        new DbDao2("pdp2", A_SEQ_PU, properties, dbUrl2).destroy();
        new DbDao2("pdp1", A_SEQ_PU, properties, dbUrl2).destroy();
        new DbDao2("pdp3", A_SEQ_PU, properties).destroy(); // mismatched URL
        new DbDao2("pdp4", A_SEQ_PU, properties, dbUrl2).destroy();
        ...
        new DbDao2("pdp1", A_SEQ_PU, properties2).destroy();
        new DbDao2("pdp3", A_SEQ_PU, properties2).destroy();
        ...
        new DbDao2("pdp3", A_SEQ_PU, properties, dbUrl2).destroy();
