 ...
 * tasks.
 */
public class DbDao2Test extends IntegrityAuditTestBase {
    ...
    public static void setUpBeforeClass() throws Exception {
        IntegrityAuditTestBase.setUpBeforeClass(DEFAULT_DB_URL_PREFIX + DbDao2Test.class.getSimpleName());
    }
    ...
    public void testNewRegistration() throws Exception {
        ...
        try (EntityTransCloser et = new EntityTransCloser(em.getTransaction())) {
            ...
            iaequery.setParameter("rn", DbDao2Test.resourceName);
            iaequery.setParameter("pu", DbDao2Test.A_SEQ_PU);
    ...
    public void testGetIntegrityAuditEntities() throws Exception {
        ...
        dbDao = new DbDao2(resourceName, A_SEQ_PU, properties);
        new DbDao2("pdp1", A_SEQ_PU, properties).destroy();
